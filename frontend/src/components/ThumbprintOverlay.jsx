...
export default function ThumbprintOverlay({ lang, onVerified, onCancel }) {
  ...
  return (
    <div className="phone-frame flex flex-col items-center bg-gradient-to-b from-slate-900 to-slate-800 p-6 text-white">
      ...
      <div className="mt-auto w-full text-center">
        <button
          onClick={handlePress}
          className="relative mx-auto mb-5 flex h-56 w-56 items-center justify-center rounded-full bg-white/5 active:scale-95"
